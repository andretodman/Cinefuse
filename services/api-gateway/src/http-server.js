    ...
    try {
      if (generationKind === "sound") {
        ...
        await saveJob({
          ...
          outputPayload: {
            ...
            providerAdapter: audioGeneration.providerAdapter ?? audioGeneration.adapter ?? null,
      ...
      await saveJob({
        ...
        outputPayload: {
          ...
          providerAdapter: soundMcpInvokeResult?.providerAdapter ?? soundMcpInvokeResult?.adapter ?? null,
